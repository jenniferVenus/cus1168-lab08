...
public class InsuranceRatingEngine {
    ...
    private String determineVehicleCategory(DriverProfile profile) {
        ...
        if(make.equals("ferrari") || make.equals("porsche")|| model.contains("mustang")|| model.contains("corvette"))
        {
            return "sports";
        }

        if(model.equals("suv") || model.equals("explorer")|| make.equals("tahoe")|| make.equals("highlander"))
        {
            return "sedan";
        }
        else
